							...
							<ul class="<?php echo WPML_TM_Old_Jobs_Editor::OPTION_NAME; ?>">
								...
								<li>
									<label>
										...
										/* translators: Which editor to use when updating content that was created with WPML's Classic Translation Editor? %s is replaced by link to documentation*/
										_e(
											sprintf(
												'Advanced Translation Editor (not recommended - %s)',
												$documentationLink
											),
											'wpml-translation-management'
										);
